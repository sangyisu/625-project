...
```{r}
set.seed(625)
load(file="/home/htzheng/23380-0034-Data.rda")
mydata = da23380.0034
...
write.csv(accuracy, file = "/home/htzheng/acrc_glm.csv", row.names = FALSE)
```
